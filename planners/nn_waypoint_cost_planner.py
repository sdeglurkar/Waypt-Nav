...
class NNWaypointCostPlanner(NNPlanner):
    ...
    def mask_and_concat_data_along_batch_dim(data, k):
        ...
        data_last['waypoint_cost'] = data['waypoint_cost'][last_data_idx]
        ...
        data['waypoint_cost'] = np.array(data['waypoint_cost'])[valid_mask]
    ...
    def convert_planner_data_to_numpy_repr(data):
        ...
        data_numpy['waypoint_cost'] = data['waypoint_cost']
