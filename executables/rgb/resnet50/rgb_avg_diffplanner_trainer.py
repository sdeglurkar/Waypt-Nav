...
class RGBAvgDiffPlannerTrainer(VisualNavigationTrainer):
    """
    ...
    def _modify_planner_params(self, p):
        ...
        """
        from planners.avg_differentiable_planner import AvgDifferentiablePlanner

        p.planner_params.planner = AvgDifferentiablePlanner
